...
draw_sidebar_home <- function(){
  tagList(
    div(
      ...
      bsButton("sbd_home_4", label = "home_4", class = "sidebar_dynamic_button", icon = icon("question"))
    )
  )
}
...
draw_sidebar_stories <- function(){
  tagList(
    div(
      ...
      bsButton("sbd_stories_4", label = "stories_4", class = "sidebar_dynamic_button", icon = icon("question"))
    )
  )
}
...
draw_sidebar_monitor <- function(){
  tagList(
    div(
      ...
      bsButton("sbd_monitor_4", label = "monitor_4", class = "sidebar_dynamic_button", icon = icon("question"))
    )
  )
}
...
draw_sidebar_explorer <- function(){
  tagList(
    div(
      ...
      bsButton("sbd_explorer_4", label = "explorer_4", class = "sidebar_dynamic_button", icon = icon("question"))
    )
  )
}
...
draw_sidebar_studies <- function(){
  tagList(
    div(
      ...
      bsButton("sbd_studies_4", label = "studies_4", class = "sidebar_dynamic_button", icon = icon("question"))
    )
  )
}
