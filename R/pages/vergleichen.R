    ...
    div(
      ...
      fluidRow(
        ...
        div(
          ...
          # 2. Schritt - Auswahl weiterer, passender Variablen
          div(
            style = "padding: 10px; display: flex; flex-direction: row; flex-wrap: wrap;",
                ...
                param_ve_vr2 <-
                  ...
                  if (param_ve_vr2 != parameter$ve_vr2){
                    ...
                    if (param_ve_vr2 == ""){
                      ...
                      # TODO hier Suche Funktion einsätzen, die die Auswahl, die dann an Gruppe/Eimer usw. geht einschränkt
