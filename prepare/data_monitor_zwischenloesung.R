...
# Indikator lehramt_beidngungen_praxisbezug
# Quelle: Lehrkraefte Monitor

#' Mising description
#' @export

give_df_praxisbezug <- function(){
  structure(
    list(
      Variable = c(
        ...
        "Verpflichtende Vorbereitungs-, Begleit- und Nachbereitungsveranstaltungen in der Praxiszeit",
        "Verpflichtende Vorbereitungs-, Begleit- und Nachbereitungsveranstaltungen in der Praxiszeit",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        ...
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Verpflichtende außerschulische Praktika", "Verpflichtende außerschulische Praktika",
        "Vorgaben zur Führung eines Portfolios", "Vorgaben zur Führung eines Portfolios",
        "Vorgaben zur Führung eines Portfolios", "Vorgaben zur Führung eines Portfolios",
        "Vorgaben zur Führung eines Portfolios", "Vorgaben zur Führung eines Portfolios",
        "Vorgaben zur Führung eines Portfolios", "Vorgaben zur Führung eines Portfolios",
        "Vorgaben zur Führung eines Portfolios", "Vorgaben zur Führung eines Portfolios",
      ...
      Bundesland = c(
        ...
        "Sachsen-Anhalt", "Schleswig-Holstein", "Thüringen", "Baden-Württemberg",
        "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen",
        "Mecklenburg-Vorpommern", "Niedersachsen", "Nordrhein-Westfalen",
        "Rheinland-Pfalz", "Saarland", "Sachsen", "Sachsen-Anhalt", "Schleswig-Holstein",
        "Thüringen", "Baden-Württemberg", "Bayern", "Berlin", "Brandenburg",
        "Bremen", "Hamburg", "Hessen", "Mecklenburg-Vorpommern", "Niedersachsen",
        "Nordrhein-Westfalen", "Rheinland-Pfalz", "Saarland", "Sachsen",
        "Sachsen-Anhalt", "Schleswig-Holstein", "Thüringen", "Baden-Württemberg",
        "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen",
      ...
      Jahr = c(
        ...
        2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2020, 2020, 2020,
        2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020,
        2020, 2020, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022,
        2022, 2022, 2022, 2022, 2022, 2022, 2022, 2015, 2015, 2015, 2015,
        2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015,
        2015, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016,
        2016, 2016, 2016, 2016, 2016, 2016, 2017, 2017, 2017, 2017, 2017,
        2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017,
        2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020,
        2020, 2020, 2020, 2020, 2020, 2022, 2022, 2022, 2022, 2022, 2022,
        2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2015,
        2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015,
        2015, 2015, 2015, 2015, 2016, 2016, 2016, 2016, 2016, 2016, 2016,
        2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2017, 2017,
        2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017,
        2017, 2017, 2017, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020,
        2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2022, 2022, 2022,
        2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022,
        2022, 2022, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015, 2015,
        2015, 2015, 2015, 2015, 2015, 2015, 2015, 2016, 2016, 2016, 2016,
        2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016, 2016,
        2016, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017, 2017,
        2017, 2017, 2017, 2017, 2017, 2017, 2020, 2020, 2020, 2020, 2020,
        2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020,
        2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022, 2022,
        2022, 2022, 2022, 2022, 2022),
      Wert = c(
        "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen",
        "Ja, Praxisphasen", "Ja, Praxisphasen", "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen und ein Praxissemester",
        ...
        "Ja, Praxisphasen und ein Praxissemester", "Ja, Praxisphasen",
        "Ja, Praxisphasen", "Ja, Praxisphasen", "Ja, Praxisphasen", "Ja, Praxisphasen und ein Praxissemester",
        "Ja, Praxisphasen", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein, aber andere Steuerungsmaßnahmen", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        ...
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein, aber andere Steuerungsmaßnahmen", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Nein", "Nein", "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein, aber geplant", "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Nein",
        "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        "Nein", "Nein", "Nein", "Nein", "Ja, verpflichtend für alle Lehramtstypen vorgegeben",
        ...
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Ja, verpflichtend für bestimmte Lehramtstypen vorgegeben",
        "Ja, verpflichtend für alle Lehramtstypen vorgegeben", "Nein",
        "Nein", "Ja, dieses dient ausschließlich der Reflexion seitens der Studierenden und wird nicht von der Hochschule eingesehen",
        "Nein", "Nein", "Nein", "Ja, dieses wird auch von der Hochschule eingesehen, aber nicht zur Benotung herangezogen",
        "Nein", "Nein", "Nein", "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
        ...
        "Nein", "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
        "Ja, dieses wird auch von der Hochschule eingesehen, aber nicht zur Benotung herangezogen",
        "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
        "Ja, dieses dient ausschließlich der Reflexion seitens der Studierenden und wird nicht von der Hochschule eingesehen",
        "Nein", "Nein", "Nein", "Ja, dieses wird auch von der Hochschule eingesehen, aber nicht zur Benotung herangezogen",
        ...
        "Ja, dieses dient ausschließlich der Reflexion seitens der Studierenden und wird nicht von der Hochschule eingesehen",
        "Nein", "Nein", "Nein", "Ja, dieses wird auch von der Hochschule eingesehen, aber nicht zur Benotung herangezogen",
        "Nein", "Nein, aber geplant", "Nein", "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
        "Ja, dieses wird auch von der Hochschule eingesehen, aber nicht zur Benotung herangezogen",
        "Ja, dieses dient ausschließlich der Reflexion seitens der Studierenden und wird nicht von der Hochschule eingesehen",
        "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
        "Nein", "Nein, das Anlegen und Führen einer solchen Dokumentation wird aber empfohlen",
      ...
      Anmerkung = c(
        NA, NA, NA, NA, NA, NA, "In Hessen werden an ausgewählten Universitäten Praxissemester für alle Lehramtsstudiengänge mit Ausnahme des Lehramtstyp 5 erprobt.",
        NA, NA, NA, NA, NA, NA, NA, "Lehrkräftebildungsgesetz Schleswig-Holstein (LehrBG) vom 15.07.14",
        "§§ 11 bis 16 ThürLbG", NA, NA, NA, "Link: http://bravors.brandenburg.de/verordnungen/lsv_2013",
        NA, NA, "In Hessen werden an ausgewählten Universitäten Praxissemester für alle Lehramtsstudiengänge mit Ausnahme des Lehramtstyp 5 erprobt.",
        NA, NA, NA, NA, NA, NA, NA, "Lehrkräftebildungsgesetz Schleswig-Holstein (LehrBG) vom 15.07.14",
        "§§ 11 bis 16 Thüringer Lehrerbildungsgesetz (ThürLbG)",
        NA, NA, NA, "Link: http://bravors.brandenburg.de", NA, NA, "In Hessen werden an ausgewählten Universitäten Praxissemester für alle Lehramtsstudiengänge mit Ausnahme des Lehramtstyp 5 erprobt.",
        NA, NA, NA, NA, NA, NA, NA, "Lehrkräftebildungsgesetz Schleswig-Holstein (LehrBG) vom 15.07.14",
        "§§ 11 bis 16 Thüringer Lehrerbildungsgesetz (ThürLbG)",
        NA, NA, NA, "https://bravors.brandenburg.de/verwaltungsvorschriften/vvschupst + https://bravors.brandenburg.de/verordnungen/lsv",
        ...
        NA, "In Hessen werden an ausgewählten Universitäten Praxissemester für alle Lehramtsstudiengänge mit Ausnahme des Lehramtstyp 5 erprobt.",
        NA, NA, NA, NA, NA, NA, "Es gibt landesweite Vorgaben über ein Praxissemester in der gestuften Studienstruktur (Master LAT 3 und LAT4).",
        "Lehrkräftebildungsgesetz Schleswig-Holstein (LehrBG) vom 15.07.14",
        "§§ 11 bis 16 Thüringer Lehrerbildungsgesetz (ThürLbG) (http://landesrecht.thueringen.de/jportal/;jsessionid=052521C459865D91E43E209F69BFF540.jp21?quelle=jlink&query=LehrBiG+TH&psml=bsthueprod.psml&max=true&aiz=true#jlr-LehrBiGTHV2P11)",
        NA, NA, NA, "https://bravors.brandenburg.de/verwaltungsvorschriften/vvschupst + https://bravors.brandenburg.de/verordnungen/lsv",
        "Außer dem Lehramt an berufsbildenden Schulen gilt grundsätzlich: Bachelorstudium: Praxisorientierte Elemente i.d.R. 3 Wo pro Fach, das Orientierungspraktikum 6 Wochen. Master: Praxissemester: ein Schulhalbjahr",
        NA, "Für den Studienbeginn ab WS 2023/24 setzt sich die praktische Ausbildung im Rahmen des Studiums aus einem Grundpraktikum in der ersten und einem Praxissemester in der zweiten Hälfte des jeweiligen Studiengangs zusammen. Schwerpunkt des Grundpraktikums ist die Reflexion der eigenen Eignung für den Beruf als Lehrkraft im jeweiligen Lehramt. Schwerpunkt des Praxissemesters ist insbesondere die Reflexion des pädagogischen Handelns anhand der im Laufe des Studiums erworbenen und vertieften Kenntnisse.",
        NA, NA, NA, NA, NA, NA, "Es gibt landesweite Vorgaben über ein Praxissemester in der gestuften Studienstruktur (Master LAT 3 und LAT4).",
        "Lehrkräftebildungsgesetz Schleswig-Holstein (LehrBG) vom 15.07.14",
        "§§ 11 bis 16 Thüringer Lehrerbildungsgesetz (ThürLbG) (http://landesrecht.thueringen.de/jportal/;jsessionid=052521C459865D91E43E209F69BFF540.jp21?quelle=jlink&query=LehrBiG+TH&psml=bsthueprod.psml&max=true&aiz=true#jlr-LehrBiGTHV2P11)",
        NA, NA, "Rahmenvereinbarung http://www.berlin.de/imperia/md/content/sen-bildung/lehrer_werden/studium/rahmenvereinbarung_schulpraktische_studien.pdf?start&ts=1439983330&file=rahmenvereinbarung_schulpraktische_studien.pdf",
        "§ 6 Absatz 3 Satz 3 der Lehramtsstudienverordnung (Link: http://www.mbjs.brandenburg.de/sixcms/detail.php/bb1.c.333659.de)",
        NA, NA, " Die Studienordnungen für das jeweilige Praxissemester im Erprobungsstatus sind durch das Hessische Kultusministerium (HKM) genehmigt und sehen entsprechende Veranstaltungen vor.",
        NA, "Grundsätzlich sind auch die Praktika der anderen Lehrämter regulär ins Studium eingebunden und damit entsprechend vorbereitet, begleitet und nachbereitet.",
        ...
        NA, NA, NA, NA, "Neben den hochschuleigenen Veranstaltungen bietet in Kooperation mit der Universität das Landesinstitut (IQSH) insgesamt acht dreistündige Reflexionsveranstaltungen für Studierende im Praxissemester an.",
        ...
        NA, NA, "Rahmenvereinbarung http://www.berlin.de/imperia/md/content/sen-bildung/lehrer_werden/studium/rahmenvereinbarung_schulpraktische_studien.pdf?start&ts=1439983330&file=rahmenvereinbarung_schulpraktische_studien.pdf",
        "§ 6 Absatz 3 Satz 3 der Lehramtsstudienverordnung (Link: http://bravors.brandenburg.de/verordnungen/lsv_2013.de)",
        NA, NA, " Die Studienordnungen für das jeweilige Praxissemester im Erprobungsstatus sind durch das Hessische Kultusministerium (HKM) genehmigt und sehen entsprechende Veranstaltungen vor.",
        NA, "Grundsätzlich sind auch die Praktika der anderen Lehrämter regulär ins Studium eingebunden und damit entsprechend vorbereitet, begleitet und nachbereitet.",
        ...
        NA, NA, NA, NA, "Neben den hochschuleigenen Veranstaltungen bietet in Kooperation mit der Universität das Landesinstitut (IQSH) insgesamt acht dreistündige Reflexionsveranstaltungen für Studierende im Praxissemester an.",
        "Aber entsprechende Veranstaltungen sind verpflichtender Bestandteil der Curricula der Hochschulen und werden mit Unterstützung von Vertretern aus dem Schulbereich umgesetzt.",
        NA, NA, "Rahmenvereinbarung über die Durchführung schulpraktischer Studien: abrufbar unter https://www.berlin.de/sen/bildung/fachkraefte/lehrerausbildung/studium/",
        ...
        NA, "Grundsätzlich sind auch die Praktika der anderen Lehrämter regulär ins Studium eingebunden und damit entsprechend vorbereitet, begleitet und nachbereitet.",
        "Vorbereitungs-, Begleit- und Nachbereitungsveranstaltungen sind gesetzlich für das Praxissemester vorgesehen. Zudem ist das Eignungs- und Orientierungspraktikum entsprechend der gesetzlichen Vorgaben bildungswissenschaftlich oder fachwissenschaftlich zu begleiten. Für die anderen Praktika sind entsprechende Veranstaltungen nicht gesetzlich vorgesehen.",
        NA, NA, NA, NA, "Neben den hochschuleigenen Veranstaltungen bietet das Landesinstitut (IQSH) in Kooperation mit den Hochschulen Reflexionsveranstaltungen für Studierende im Praxissemester an.",
        "Aber entsprechende Veranstaltungen sind verpflichtender Bestandteil der Curricula der Hochschulen und werden mit Unterstützung von Vertretern aus dem Schulbereich umgesetzt.",
        NA, NA, " Rahmenvereinbarung über die Durchführung schulpraktischer Studien: abrufbar unter https://www.berlin.de/sen/bildung/fachkraefte/lehrerausbildung/studium/",
        "§ 6 Absatz 3 der Lehramtsstudienverordnung (Link: http://bravors.brandenburg.de)",
        NA, NA, "Die praktische Ausbildung im Rahmen des Studiums wird durch Veranstaltungen der Hochschulen, insbesondere in den Bildungswissenschaften und Didaktiken, vorbereitet, begleitet und ausgewertet.",
        NA, "Grundsätzlich sind auch die Praktika der anderen Lehrämter regulär ins Studium eingebunden und damit entsprechend vorbereitet, begleitet und nachbereitet.",
        "Vorbereitungs-, Begleit- und Nachbereitungsveranstaltungen sind gesetzlich für das Praxissemester vorgesehen. Zudem ist das Eignungs- und Orientierungspraktikum entsprechend der gesetzlichen Vorgaben bildungswissenschaftlich oder fachwissenschaftlich zu begleiten. Für die anderen Praktika sind entsprechende Veranstaltungen nicht gesetzlich vorgesehen.",
        NA, NA, NA, NA, "Neben den hochschuleigenen Veranstaltungen bietet das Landesinstitut (IQSH) in Kooperation mit den Hochschulen Reflexionsveranstaltungen für Studierende im Praxissemester an.",
        "Aber entsprechende Veranstaltungen sind verpflichtender Bestandteil der Curricula der Hochschulen und werden mit Unterstützung von Vertretern aus dem Schulbereich umgesetzt.",
        ...
        NA, NA, NA, NA, NA, "Die künftig geplante Verpflichtung soll Ausnahmen zulassen: Geplant ist ein in der Regel außerschulisches Berufsfeldpraktikum.",
        ...
        "http://www.uni-saarland.de/fileadmin/user_upload/Einrichtungen/zfl/ordnungen/modularisierte_lehramtsstudiengaenge/Ordnung_Betriebspraktika_02-03-09.pdf",
        NA, NA, NA, NA, "Außerschulische Praktika sind aber für die Zulassung zum Vorbereitungsdienst erforderlich: Für alle Anwärter/Referendare ist ein Betriebs- oder Sozialpraktikum (mindestens 3 Wochen) erforderlich bzw. für Lehramtsstudierende mit dem Fach Sport ein Vereinspraktikum und für Lehramtsstudierende der Fächer Politikwissenschaft, Wirtschaftswissenschaft, Geographie und Informatik ein Betriebspraktikum (mindestens 3 Wochen). Lehramtstyp 5: Alle Bewerber müssen vor dem Eintritt in den Vorbereitungsdienst ein 52-wöchiges Betriebspraktikum abgeleistet haben (Schulpraxis wird i.d.R. angerechnet). Je nach Schultyp sind bestimmte Module vorgesehen.",
        "Betriebspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 1 Lehramtsprüfungsordnung I (LPO I). Das Orientierungspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 2 Lehramtsprüfungsordnung I (LPO I) kann teilweise auch in außerschulischen Einrichtungen abgeleistet werden.",
        NA, "Gemäß § 6 Absatz 2 Satz 2 der Lehramtsstudienverordnung soll ein Praktikum im Bachelorstudium in pädagogisch-psychologischen Handlungsfeldern, die sich nicht auf den obligatorischen oder wahlobligatorischen Unterricht beziehen, durchgeführt werden. Gemäß der einschlägigen Hochschulordnung kann das Praktikum im außerschulischen Bereich, in Einrichtungen der öffentlichen und freien Jugendhilfe, im Elementarbereich und außerunterrichtlichen Bereich sowie in entsprechenden erziehungswissenschaftlichen Forschungsprojekten mit Praxisanteilen absolviert werden. (Link: http://www.mbjs.brandenburg.de/sixcms/detail.php/bb1.c.333659.de)",
        NA, NA, NA, NA, NA, "Die Verpflichtung lässt Ausnahmen zu: In der Regel soll ein außerschulisches Berufsfeldpraktikum absolviert werden.",
        "Lehramt an berufsbildenden Schulen: 12 Monate Praxis spätestens bis Eintritt in den Vorbereitungsdienst, Betriebspraktika für alle Lehrämter werden empfohlen und können ein Orientierendes Schulpraktikum ersetzen.",
        "http://www.uni-saarland.de/fileadmin/user_upload/Einrichtungen/zfl/ordnungen/modularisierte_lehramtsstudiengaenge/Ordnung_Betriebspraktika_02-03-09.pdf",
        NA, NA, NA, NA, "Außerschulische Praktika sind aber für die Zulassung zum Vorbereitungsdienst erforderlich: Für alle Anwärter/Referendare ist ein Betriebs- oder Sozialpraktikum (mindestens 3 Wochen) erforderlich bzw. für Lehramtsstudierende mit dem Fach Sport ein Vereinspraktikum und für Lehramtsstudierende der Fächer Politikwissenschaft, Wirtschaftswissenschaft, Geographie und Informatik ein Betriebspraktikum (mindestens 3 Wochen). Lehramtstyp 5: Alle Bewerber müssen vor dem Eintritt in den Vorbereitungsdienst ein 52-wöchiges Betriebspraktikum abgeleistet haben (Schulpraxis wird i.d.R. angerechnet). Je nach Schultyp sind bestimmte Module vorgesehen.",
        "Betriebspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 1 Lehramtsprüfungsordnung I (LPO I). Das Orientierungspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 2 Lehramtsprüfungsordnung I (LPO I) kann teilweise auch in außerschulischen Einrichtungen abgeleistet werden.",
        NA, "Gemäß § 6 Absatz 2 Satz 2 der Lehramtsstudienverordnung soll ein Praktikum im Bachelorstudium in pädagogisch-psychologischen Handlungsfeldern, die sich nicht auf den obligatorischen oder wahlobligatorischen Unterricht beziehen, durchgeführt werden. Gemäß der einschlägigen Hochschulordnung kann das Praktikum im außerschulischen Bereich, in Einrichtungen der öffentlichen und freien Jugendhilfe, im Elementarbereich und außerunterrichtlichen Bereich sowie in entsprechenden erziehungswissenschaftlichen Forschungsprojekten mit Praxisanteilen absolviert werden. (Link: http://www.mbjs.brandenburg.de/sixcms/detail.php/bb1.c.333659.de)",
        NA, NA, NA, NA, NA, "Die Verpflichtung lässt Ausnahmen zu: Das Berufsfeldpraktikum soll in der Regel außerschulisch absolviert werden, Anrechnungen von nachgewiesenen beruflichen Tätigkeiten sind nach §9 Lehramtszugangsverordnung (2016) möglich.",
        "Lehramt an berufsbildenden Schulen: 12 Monate Praxis spätestens bis Eintritt in den Vorbereitungsdienst, Betriebspraktika für alle Lehrämter werden empfohlen und können ein Orientierendes Schulpraktikum ersetzen.",
        "http://www.uni-saarland.de/fileadmin/user_upload/Einrichtungen/zfl/ordnungen/modularisierte_lehramtsstudiengaenge/Ordnung_Betriebspraktika_02-03-09.pdf",
        NA, NA, NA, NA, "Außerschulische Praktika sind aber für die Zulassung zum Vorbereitungsdienst erforderlich: Für alle Anwärter/Referendare ist ein Betriebs- oder Sozialpraktikum (mindestens 3 Wochen) erforderlich bzw. für Lehramtsstudierende mit dem Fach Sport ein Vereinspraktikum und für Lehramtsstudierende der Fächer Politikwissenschaft, Wirtschaftswissenschaft, Geographie und Informatik ein Betriebspraktikum (mindestens 3 Wochen). Lehramtstyp 5: Alle Bewerber müssen vor dem Eintritt in den Vorbereitungsdienst ein 52-wöchiges Betriebspraktikum abgeleistet haben (Schulpraxis wird i.d.R. angerechnet). Je nach Schultyp sind bestimmte Module vorgesehen.",
        "Betriebspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 1 Lehramtsprüfungsordnung I (LPO I). Das Orientierungspraktikum gemäß § 34 Abs. 1 Satz 1 Nr. 2 Lehramtsprüfungsordnung I (LPO I) kann teilweise auch in außerschulischen Einrichtungen abgeleistet werden.",
        ...
        "http://www.uni-saarland.de/fileadmin/user_upload/Einrichtungen/zfl/ordnungen/modularisierte_lehramtsstudiengaenge/Ordnung_Betriebspraktika_02-03-09.pdf",
        NA, NA, NA, "Bewerber für den Vorbereitungsdienst für das Lehramt an berufsbildenden Schulen müssen gemäß den geltenden Rahmenvereinbarungen zum Lehramtstyp 5 ein Zeugnis über eine abgeschlossene einschlägige Berufsausbildung oder fachpraktische Tätigkeiten von einem Jahr nachweisen. Dies ist in § 4 Abs. 3Nr. 6 der Thüringer Verordnung über die Ausbildung und Zweite Staatsprüfung für die Lehrämter (ThürAZStPLVO) vom 26. April 2016 geregelt.",
        NA, NA, NA, NA, "Verpflichtende Vorgabe der Universität Bremen",
        NA, NA, NA, NA, "Das Portfolio wird ab Beginn des Eignungspraktikums bis zum Ende des Vorbereitungsdienstes geführt. Es besteht aus einem Dokumentations- und einem Reflexionsteil. Der Dokumentationsteil kann von der Hochschule eingesehen werden.",
        "Das Praktikumsbuch kann der Hochschule von den Studierenden (freiwillig) vorgelegt werden.",
        NA, NA, NA, NA, NA, NA, NA, NA, NA, "Verpflichtende Vorgabe der Universität Bremen",
        NA, NA, NA, NA, "Das Portfolio wird bis zum Ende des Vorbereitungsdienstes geführt. Es besteht aus einem Dokumentations- und einem Reflexionsteil. Der Dokumentationsteil kann von der Hochschule eingesehen werden",
        "Das Praktikumsbuch kann der Hochschule von den Studierenden (freiwillig) vorgelegt werden.",
        NA, NA, NA, NA, NA, NA, NA, NA, NA, "Verpflichtende Vorgabe der Universität Bremen",
        NA, NA, NA, NA, "Das Portfolio wird bis zum Ende des Vorbereitungsdienstes geführt. Es besteht aus einem Dokumentations- und einem Reflexionsteil. Der Dokumentationsteil kann von der Hochschule eingesehen werden",
        "Das Praktikumsbuch kann der Hochschule von den Studierenden (freiwillig) vorgelegt werden.",
        NA, NA, NA, NA, NA, NA, NA, NA, "Die Studienordnungen der Universität Potsdam sehen dies aber vor.",
        "Verpflichtende Vorgabe der Universität Bremen", NA, NA, NA,
        NA, "Das Portfolio wird bis zum Ende des Vorbereitungsdienstes geführt. Es besteht aus einem Dokumentations- und einem Reflexionsteil. Der Dokumentationsteil kann von der Hochschule eingesehen werden",
        "Das Praktikumsbuch kann der Hochschule von den Studierenden (freiwillig) vorgelegt werden.",
        NA, NA, NA, NA, NA, NA, NA, NA, "Die Studienordnungen der Universität Potsdam (einzige lehrerbildende Universität in Brandenburg) sehen dies aber vor.",
        "Verpflichtende Vorgabe der Universität Bremen", "Reflexionsportfolios oder vergleichbare Instrumente, die den eigenen Kompetenzerwerb dokumentieren und kritisch konstruktiv begleiten, sind in unterschiedlicher Ausprägung Bestandteil aller schulpraktischen Studien und in den Modulbeschreibungen hinterlegt.",
        ...
        NA, NA, "Das Portfolio wird bis zum Ende des Vorbereitungsdienstes geführt. Es besteht aus einem Dokumentations- und einem Reflexionsteil. Der Dokumentationsteil kann von der Hochschule eingesehen werden",
        "Das Praktikumsbuch kann der Hochschule von den Studierenden (freiwillig) vorgelegt werden.",
        NA, NA, NA, NA, NA
      )
...
# Indikator bedingungen_experimentierklausel
# Quelle: Stifterverband

#' Missing description
#' @export

give_df_experimentierklausel <- function(){
  tribble(
    ~Region,              ~Jahr, ~Wert,
    "Baden-Württemberg",      2023,  "Keine Experimentierklausel etabliert",
    "Bayern",                 2023,  "Experimentierklausel mit begrenztem Umfang etabliert",
    "Berlin",                 2023,  "Experimentierklausel mit begrenztem Umfang etabliert",
    "Brandenburg",            2023,  "Experimentierklausel mit begrenztem Umfang etabliert",
    "Bremen",                 2023,  "Keine Experimentierklausel etabliert",
    "Hamburg",                2023,  "Keine Experimentierklausel etabliert",
    "Hessen",                 2023,  "Keine Experimentierklausel etabliert",
    "Mecklenburg-Vorpommern", 2023,  "Experimentierklausel mit begrenztem Umfang etabliert",
    "Niedersachsen",          2023,  "Keine Experimentierklausel etabliert",
    "Nordrhein-Westfalen",    2023,  "Keine Experimentierklausel etabliert",
    "Rheinland-Pfalz",        2023,  "Keine Experimentierklausel etabliert",
    "Saarland",               2023,  "Keine Experimentierklausel etabliert",
    "Sachsen",                2023,  "Keine Experimentierklausel etabliert",
    "Sachsen-Anhalt",         2023,  "Keine Experimentierklausel etabliert",
    "Schleswig-Holstein",     2023,  "Keine Experimentierklausel etabliert",
    "Thüringen",              2023,  "Keine Experimentierklausel etabliert"
  )
}

# Indikator flexibilisierung haws
# Quelle: Stifterverband

#' Missing description
#' @export

give_df_haws <- function(){
  tribble(
    ~Region,              ~Jahr, ~Wert,
    "Baden-Württemberg",      2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Bayern",                 2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Berlin",                 2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Brandenburg",            2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Bremen",                 2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Hamburg",                2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Hessen",                 2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Mecklenburg-Vorpommern", 2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Niedersachsen",          2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Nordrhein-Westfalen",    2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Rheinland-Pfalz",        2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Saarland",               2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Sachsen",                2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Sachsen-Anhalt",         2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Schleswig-Holstein",     2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung",
    "Thüringen",              2024,  "keine gleichberechtigten Partner in Lehrkräfteausbildung"
  )
}

# Indikator flexibilisierung einfach-bachelor
# Quelle: Stifterverband

#' Missing description
#' @export

give_df_einfach_bachelor <- function(){
  tribble(
    ~Region,              ~Jahr, ~Wert,
    "Baden-Württemberg",      2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Bayern",                 2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Berlin",                 2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Brandenburg",            2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Bremen",                 2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Hamburg",                2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Hessen",                 2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Mecklenburg-Vorpommern", 2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Niedersachsen",          2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Nordrhein-Westfalen",    2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Rheinland-Pfalz",        2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Saarland",               2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Sachsen",                2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Sachsen-Anhalt",         2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Schleswig-Holstein",     2024,  "Kein Ein-Fach-Studium Lehramt möglich",
    "Thüringen",              2024,  "Kein Ein-Fach-Studium Lehramt möglich"
  )
}

# Indikator flexibilisierung trichter
# Quelle: Stifterverband

#' Missing description
#' @export

give_df_lehrkraefte_trichter <- function() {
  data.frame(
    x_var = c("Beginn Studium", "Mitte Studium", "Ende Studium", "Beginn Referendariat", "Ende Referendariat", "Neu eingestellte Lehrkräfte"),
